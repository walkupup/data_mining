...
train = pd.read_csv('E:\data\competition\jinnan1\data+ans\jinnan_round1_train_20181227.csv', encoding = 'gb18030')
test  = pd.read_csv('E:\data\competition\jinnan1\data+ans\jinnan_round1_testA_20181227.csv', encoding = 'gb18030')
...
stats1 = stats_df.sort_values('Percentage of missing values', ascending=False)[:10]
...
sub_df = pd.read_csv('datalab/7955/jinnan_round1_submit_20181227.csv', header=None)
